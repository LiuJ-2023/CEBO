function f_best = CEBO(problem_num)
if problem_num == 1
    up = [1 1 1 1 1 1 1 1 1 10 10 10 1];
...
elseif problem_num == 7
    ...
    dn = [-10 -10 -10 -10 -10 -10 -10 -10 -10 -10];
    d = 10;
    df = 9;
elseif problem_num == 8
    ...
    d = 2;
    df = 3;
elseif problem_num == 9
    up = [10 10 10 10 10 10 10];
    dn = [-10 -10 -10 -10 -10 -10 -10];
    d = 7;
    df = 5;
elseif problem_num == 10
    up = [10000 10000 10000 1000 1000 1000 1000 1000];
    dn = [100 1000 1000 10 10 10 10 10];
    d = 8;
    df = 7;
elseif problem_num == 12
    up = [10 10 10];
    dn = [0 0 0];
    d = 3;
    df = 2;
elseif problem_num == 18
    up = [10 10 10 10 10 10 10 10 20]; 
    dn = [-10 -10 -10 -10 -10 -10 -10 -10 0];
    d = 9;
    df = 14;
elseif problem_num == 19
    up = 10 * ones(1, 15);
    dn = zeros(1, 15);
    d = 15;
    df = 6;
elseif problem_num == 24
    up = [3 4];
    dn = [0 0];
    d = 2;
    df = 3;
...
DB_y = Fitness_CEC2006(DB_x,problem_num);
...
for gen = 1:25  
    ...
    f_q = Fitness_CEC2006(x_q,problem_num);
    % Update the Database
    DB_x = [DB_x;x_q];
    DB_y = [DB_y;f_q];
    % Update alpha
