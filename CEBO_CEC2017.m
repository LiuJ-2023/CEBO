function f_best = CEEIBO_T(problem_num)
...
elseif problem_num == 19
    ...
    d = 10;
    df = 3;
elseif problem_num == 20
    up = 100*ones([1,10]);
    dn = -100*ones([1,10]);
    d = 10;
    df = 3;
elseif problem_num == 22
    up = 100*ones([1,10]);
    dn = -100*ones([1,10]);
    d = 10;
    df = 3;
elseif problem_num == 28
    up = 100*ones([1,10]);
    dn = -100*ones([1,10]);
    d = 10;
    df = 3;
...
DB_y = Fitness_2017(DB_x,problem_num);
...
for gen = 1:25  
    ...
    f_q = Fitness_2017(x_q,problem_num);
    % Update the Database
    DB_x = [DB_x;x_q];
    DB_y = [DB_y;f_q];
    % Update alpha
